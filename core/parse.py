"""The tolerant parser, ported from pixels-rag core/parse.py. Native
structured output makes it a fallback; every reply records which path
handled it: native, recovered or failed."""
